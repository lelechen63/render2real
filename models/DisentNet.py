...
class DisentNet(BaseModel):
    ...
    def forward(self, image, map_image, map_type, infer=False):
        ...
        return [ self.loss_filter( loss_G_pix3, loss_G_pix4, loss_G_pix, loss_G_VGG3, loss_G_VGG4, loss_G_VGG), None if not infer else [Aexp_Aid_image, Bexp_Bid_image, Aexp_Bid_image, Aid_Bexp_image] ]
